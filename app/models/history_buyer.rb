class HistoryBuyer
  ...
  attr_accessor :postal_code, :delivery_area_id, :municipalities, :address, :building, :phone_number, :history, :user_id,
                :item_id, :token
  ...
  def save
    ...
    Buyer.create(postal_code: postal_code, delivery_area_id: delivery_area_id, municipalities: municipalities, address: address,
                 building: building, phone_number: phone_number, history: history)
  end
end
